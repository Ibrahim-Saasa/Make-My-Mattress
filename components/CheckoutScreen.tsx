  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-white dark:bg-slate-950">
      ...
      <main className="relative z-10 mx-auto max-w-4xl space-y-10 px-6 pb-36 pt-24">
        {isEmpty ? (
          <section className="rounded-[2.5rem] border border-theme-border bg-theme-card p-10 text-center shadow-theme-light">
            <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-3xl bg-indigo-600 text-white">
              <svg
                className="h-10 w-10"
                fill="none"
                stroke="currentColor"
            ...
            <p className="mt-4 text-sm leading-6 text-theme-secondary">
              Add a product from the brand hall to start building your perfect
              mattress setup.
            </p>
            <button
              onClick={onBack}
              className="mt-8 inline-flex rounded-full bg-indigo-600 px-8 py-4 text-sm font-black uppercase tracking-[0.18em] text-white transition hover:bg-indigo-700"
            >
              Continue shopping
            </button>
          </section>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-theme-secondary">
                        Save the exact location and pincode for delivery
                        updates.
                      </p>
                    </div>
                  </div>
