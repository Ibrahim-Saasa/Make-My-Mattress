        ...
        <header className="fixed top-0 w-full z-40 bg-theme-card backdrop-blur-xl border-b border-theme-border px-6 py-4">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-2 cursor-pointer group" onClick={() => navigate('/brand-hall')}>
              ...
              <span className="font-bold tracking-tight text-theme-primary uppercase text-sm">Hindustan Mattress Co.</span>
            </div>
            <div className="flex items-center gap-6">
              {userName && (
                <span className="text-sm font-bold text-theme-secondary">Hello, {userName}!</span>
              )}
              <button 
              ...
              <button onClick={handleLogout} className="text-xs font-bold text-theme-secondary hover:text-indigo-600 uppercase tracking-widest transition-colors">Logout</button>
            </div>
          </div>
        </header>
      )}
